...
public class SOAPPublisherClient {
    ...
    public static void main(String[] args) throws MalformedURLException {
        URL wsdlURL = new URL("http://localhost:8080/soap/welcome?wsdl");
        //check above URL in browser, you should see WSDL file

        //creating QName using targetNamespace and name
        QName qname = new QName("http://server/", "PersonServiceImplService");
        ...
        //add person
        System.out.println("Add server.Person Status="+ps.addPerson(p1));
        System.out.println("Add server.Person Status="+ps.addPerson(p2));
        ...
        //delete person
        System.out.println("Delete server.Person Status="+ps.deletePerson(2));
